...
<%
    ...
    // bList안에 키 값이 comments인 bList.get(1) -> commentList (BoardComment.java 참고)
    // model.addAttribute("bList", bList); // 여기 "bList"와 아래 "bList"를 맞춰야 함!
    List<Map<String, Object>> bList = (List)request.getAttribute("bList");
    List<Map<String, Object>> commentList = null;
    Map<String, Object> rmap = new HashMap<>();
    if (bList!=null) {
        size = bList.size();
        rmap = bList.get(0); // 상세보기 내용 담김
        // {comments:[{},{},{}]}
        if (size==2) {
...
<head>
    ...
    const boardList = () => {
        ...
        const commentDelete = (bc_no) => {
            <%--console.log("./commentDelete?bc_no="+bc_no+"&b_no="+<%=rmap.get("B_NO")%>);--%>
...
<div class="container">
    ...
    <!-- 댓글쓰기 시작  -->
    <div class="card">
        <form id="f_comment" method="get" action="./commentInsert">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="f_board" method="get" action="./boardUpdate">
